...
#define PATROL_PID_KI 0.05
#define PATROL_PID_KD 0.02
#define PATROL_BASIC_SPEED 18
#define PATROL_TURN_SPEED 2.9
#define PATROL_STOP_THRESHOLD 8
#define PATROL_LAST 3
#define PATROL_TURN_TIME 900
#define PATROL_POS 0.4
#define PATROL_NEG 2.0
#define PATROL_SPEED_DIV 16.0
...
#define SONAR_HISTORY 4
#define SONAR_THRES 15
