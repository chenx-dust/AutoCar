...
PID_controller motor_pid_l = {MOTOR_PID_KP, MOTOR_PID_KI, MOTOR_PID_KD, TIMER_PERIOD / 1000.0, 0.0, {0.0, 0.0, 0.0}};
PID_controller motor_pid_r = {MOTOR_PID_KP, MOTOR_PID_KI, MOTOR_PID_KD, TIMER_PERIOD / 1000.0, 0.0, {0.0, 0.0, 0.0}};

Motor motor_l = {&enc_l, &motor_pid_l, MOTOR_L_PIN};
Motor motor_r = {&enc_r, &motor_pid_r, MOTOR_R_PIN};

PID_controller patrol_pid = {PATROL_PID_KP, PATROL_PID_KI, PATROL_PID_KD, TIMER_PERIOD / 1000.0, 0.0, {0.0, 0.0, 0.0}};
